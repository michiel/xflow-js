...
const FlowNodeDispatch      = FlowActions.FlowNodeDispatch;
const FlowNodeDispatchQ     = FlowActions.FlowNodeDispatchQ;

const ObjectNodeDispatch    = FlowActions.ObjectNodeDispatch;
const ObjectNodeDispatchQ   = FlowActions.ObjectNodeDispatchQ;

// const ListNodeDispatch      = FlowActions.ListNodeDispatch;
// const ListNodeDispatchQ     = FlowActions.ListNodeDispatchQ;
 ...
 * XFlowExecutor class.
 * @class XFlowExecutor
 * @fires XFlowExecutor#start
 * @fires XFlowExecutor#end
 * @fires XFlowExecutor#nextStep
 */
class XFlowExecutor {


  /**
   * XFlowExecutor constructor
   * @constructor XFlowExecutor
